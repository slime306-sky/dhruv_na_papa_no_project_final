    ...
    def add_data(self, date: str, name: str, box: int, total_item: int, option_input: float, option: str, count: str, both: str, company: str):
        ...
        if both == "":
            if option == "paisa":
                ...
                if count == "":
                    if total_item == "":
                        self.calculatePaisausingDozenTotalItem(self,cursor,date, name, box, dazon , option_input,company)
                    else:
                        self.calculatePaisaUsingTotalItem(self,cursor,date, name, box, dazon ,total_item, option_input,company)
            else:
            ...
            if count == "on":
                ...
                if total_item == "":
                    ...
                    self.calculateBothUsingTotalitem(self,cursor,date, name, box, dazon,total_item , option_input,both,company)
